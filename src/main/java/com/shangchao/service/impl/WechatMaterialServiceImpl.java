...
import com.shangchao.commons.MassNewsResult;
import com.shangchao.commons.MaterialResult;
import com.shangchao.commons.ResultState;
import com.shangchao.commons.WechatMaterialConstant;
import com.shangchao.config.WechatMaterialConfig;
import com.shangchao.entity.UploadNewsEntity;
import com.shangchao.service.WechatMaterialService;
import com.shangchao.utils.HttpUtil;
import com.shangchao.utils.JsonUtil;
import com.shangchao.utils.MaterialUtil;
...
public class WechatMaterialServiceImpl implements WechatMaterialService {
    ...
    public MaterialResult uploadTempMediaFile(String accessToken, String type, String filePath) {
        ...
        try {
            String result = MaterialUtil.uploadMediaFile("https://api.weixin.qq.com/cgi-bin/media/upload", params, filePath);
    ...
    public MaterialResult uploadTempMediaUrl(String accessToken, String type, String url) {
        ...
        params.put("type", type);
        try {
            String result = MaterialUtil.uploadMediaUrl("https://api.weixin.qq.com/cgi-bin/media/upload", params, url);
            return JsonUtil.fromJson(result, MaterialResult.class);
        } catch (Exception e) {
            log.error(e.getMessage());
        }
    ...
    public MaterialResult uploadForeverMediaFile(String accessToken, String type, String filePath) {
        ...
        params.put("type", type);
        try {
            String result = MaterialUtil.uploadMediaFile("https://api.weixin.qq.com/cgi-bin/material/add_material", params, filePath);
            return JsonUtil.fromJson(result, MaterialResult.class);
        } catch (Exception e) {
            log.error(e.getMessage());
        }
    ...
    public MaterialResult uploadForeverMediaUrl(String accessToken, String type, String url) {
        ...
        params.put("type", type);
        try {
            String result = MaterialUtil.uploadMediaUrl("https://api.weixin.qq.com/cgi-bin/material/add_material", params, url);
            return JsonUtil.fromJson(result, MaterialResult.class);
        } catch (Exception e) {
            log.error(e.getMessage());
        }
...
//     * @see WechatMassService#uploadForMassNewsFile
    ...
    public String uploadNewsMedia(String accessToken, UploadNewsEntity entity) {
        ...
        String result = HttpUtil.doPost("https://api.weixin.qq.com/cgi-bin/material/add_news", params, data);
...
//    }
    ...
    public ResultState deleteMaterial(String accessToken, String mediaId) {
        ...
        JsonObject data = new JsonObject();
        data.addProperty("media_id", mediaId);
        String result = HttpUtil.doPost("https://api.weixin.qq.com/cgi-bin/material/del_material", params, data.toString());
